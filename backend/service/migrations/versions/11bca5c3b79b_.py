...
Revision ID: 11bca5c3b79b
Revises: 
Create Date: 2025-01-01 17:48:14.611399
...
def upgrade():
    ...
    sa.Column('time_slot', postgresql.TIME(), nullable=False),
    ...
    sa.Column('room_id', sa.SMALLINT(), nullable=False),
